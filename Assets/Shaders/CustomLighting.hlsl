...
void MainLight_float(float3 WorldPos,float3x3 DirectionRotation, out float3 Direction, out float3 Color, out float DistanceAtten, out float ShadowAtten)
{
    ...
    Direction = mul(DirectionRotation,mainLight.direction);
...
void MainLight_half(float3 WorldPos,float3x3 DirectionRotation, out half3 Direction, out half3 Color, out half DistanceAtten, out half ShadowAtten)
{
#if SHADERGRAPH_PREVIEW
